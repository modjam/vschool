...
var app = angular.module('modelCtrl', ['geolocation', 'gservice', 'requestsModule']);
app.controller('modelCtrl', function ($scope, $log, $http, $rootScope, geolocation, gservice, reqService) {
    ...
    $scope.loadData = function () {
        ...
        console.log($scope.dataFromMap)
            //    $scope.dataFromMap = $scope.dataFromMap.map(function(item) {
...
var app = angular.module('gservice', [])
    .factory('gservice', function ($rootScope, $http, $location) {
        ...
        var Location = function (latlon, message, username, gender, age, favlang, experince, skill, note, email, phone, personalImage) {
            this.latlon = latlon;
