var app = angular.module('myApp', ['addCtrl', 'queryCtrl','modelCtrl', 'headerCtrl', 'geolocation', 'gservice', 'ngRoute','app.community','tokenModule','app.signin','app.signup',"privModule","userModule",'myApp.profile'])
